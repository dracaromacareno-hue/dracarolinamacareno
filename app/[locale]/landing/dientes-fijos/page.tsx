...
const WA = 'Hola, quiero información sobre recuperar mis dientes fijos con implantes';
...
export async function generateMetadata({
  ...
  return {
    ...
    description: isEs
      ? 'Solución permanente para dientes perdidos: implantes y prótesis fija atornillada en Medellín. Come, habla y sonríe sin límites. Valoración con la especialista.'
      : 'Permanent solution for missing teeth. Dental implants and fixed prosthetics in Medellín. Eat, talk and smile without limits. Assessment with the specialist.',
    alternates: {
    ...
    <div style={{ backgroundColor: '#FCFBF9', minHeight: '100vh', fontFamily: 'system-ui, sans-serif' }}>
      ...
      <section className="relative pt-28 pb-20 px-4 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <WhatsAppLink message={WA} locale={locale as 'es' | 'en'} trackingLabel="dientes_fijos_hero"
              ...
              {isEs ? '¿Soy candidato? Envía tu caso por WhatsApp' : 'Am I a candidate? Send your case on WhatsApp'}
            </WhatsAppLink>
      ...
      <section className="py-20 px-4" style={{ background: 'linear-gradient(135deg, #FFFFFF 0%, #FCFBF9 55%, #F6F1E8 100%)' }}>
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <WhatsAppLink message={WA} locale={locale as 'es' | 'en'} trackingLabel="dientes_fijos_bottom"
