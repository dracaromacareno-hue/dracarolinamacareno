...
export const blogPosts: BlogPost[] = [
  {
    ...
    seoDescription: 'Plan y precio por escrito, fechas reservadas, itinerario día por día, aeropuerto y hospedaje filtrado. Qué se resuelve antes de que compres el tiquete.',
    seoDescriptionEn: 'Written plan and price, reserved dates, a day-by-day itinerary, airport pickup and vetted lodging. What gets resolved before you buy the ticket.',
...
<p>If you want the detail of what coordination includes, it is laid out on the company's site: <a href="https://consultoriadentalcm.com/en/patient-coordination" target="_blank" rel="noopener">International patient coordination</a>.</p>`,
  },
  {
    ...
    seoDescriptionEn: 'An All-on-4 in Puerto Rico costs double or triple what it does in Medellín, with the same implant brands and no interpreter. What changes and what does not.',
...
<p><a href="/en/dental-tourism-colombia">See how the full process works for international patients</a> or review in detail <a href="/en/all-on-4-medellin">what an All-on-4 in Medellín includes</a>.</p>`,
  },
  {
    ...
    seoDescriptionEn: 'How many days off to request for a single implant, All-on-4, smile design or full rehabilitation. Real ranges per case and how the two-trip model works.',
...
<p>Message us on WhatsApp with your home city and a photo of your smile. We will tell you how many days to request before you buy the first ticket.</p>`,
  },
  {
    ...
    seoDescriptionEn: 'What you really feel during and after implant surgery, with no sugarcoating, and what to do if the dentist terrifies you. Fear is why most people wait.',
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: 'Sí. El procedimiento se hace siempre con anestesia local, y además existe la opción de sedación consciente con anestesiólogo presente, indicada sobre todo si tienes fobia dental o si se van a colocar varios implantes en una sola sesión. Se define en la valoración, según tu caso y tu historia médica.',
      },
      {
        question: '¿Qué duele más, sacar una muela o poner un implante?',
        answer: 'En realidad es igual, y en ninguno de los dos deberías sentir dolor. Ambos procedimientos se realizan con anestesia local y, si lo prefieres, con sedación consciente. El proceso de inflamación postoperatoria y de cicatrización también es similar. Mientras sigas las indicaciones que se te dan, no vas a sentir dolor.',
      },
      {
...
<p>El problema es que el recuerdo tiene veinte o treinta años y la odontología de hoy no se parece a esa. La planificación digital, la anestesia local moderna y la posibilidad de trabajar bajo sedación consciente cambiaron la experiencia por completo.</p>
...
<p>Sí. El procedimiento se hace siempre con anestesia local, y además existe la opción de sedación consciente con anestesiólogo presente, indicada sobre todo si tienes fobia dental o si se van a colocar varios implantes en una sola sesión. Se define en la valoración, según tu caso y tu historia médica.</p>
<h3>¿Qué duele más, sacar una muela o poner un implante?</h3>
<p>En realidad es igual, y en ninguno de los dos deberías sentir dolor. Ambos procedimientos se realizan con anestesia local y, si lo prefieres, con sedación consciente. El proceso de inflamación postoperatoria y de cicatrización también es similar. Mientras sigas las indicaciones que se te dan, no vas a sentir dolor.</p>
...
<p>Your fear is valid. But every year that passes with an empty space is bone that resorbs, and that can make treatment more complex later.</p>`,
  },
  {
    ...
    seoDescriptionEn: 'How to choose an oral rehabilitation specialist in Medellín: 7 criteria to verify, the 10 questions to ask, and the red flags before accepting a plan.',
...
<p>What matters most: always ask for the total in writing, and ask for a breakdown of surgery, implants, temporary prosthesis and definitive prosthesis.</p>`,
  ...
  },
  {
    ...
    seoDescriptionEn: 'Straumann and Neodent: two reference brands from the same group, both FDA cleared. I explain their portfolios and how I pick the right one for your case.',
...
<p>Book an evaluation on WhatsApp and I will gladly answer your questions and, together, define the best brand and the best plan for your case. The right brand is the one your mouth needs, not the one that sounds most expensive.</p>`,
  },
  {
    ...
    seoDescriptionEn: 'When bone is missing or the case is complex, who operates matters as much as the implant. What a maxillofacial surgeon solves and a general dentist cannot.',
...
<p>If you have a complex case or were told nothing could be done because of missing bone, do not settle for that answer without a second opinion with imaging. Message me on WhatsApp, tell me about your case and, if you have a recent scan or X-ray, we will review it to tell you honestly whether you are a candidate and what the plan would be.</p>`,
  },
  {
    ...
    seoDescriptionEn: 'An overdenture anchors to 2 or 4 implants: far more stable than a plate and cheaper than a fixed prosthesis. The four options and what each really costs.',
...
<p>If you are tired of a denture that moves but a full fixed prosthesis is out of your budget, the implant overdenture may be exactly the middle ground you need. Message me on WhatsApp, tell me about your case and, if you have a recent X-ray or scan, I will review it to give you an exact quote in USD before you make any decision.</p>`,
  },
  {
    ...
    seoDescriptionEn: 'All-on-4 or All-on-6: the difference is how many implants hold the arch. Neither wins in the abstract. 3D planning on your bone and bite decides it.',
...
<p>Book an evaluation to study your case with a 3D scan and define, with real data, how many implants you truly need. Message me directly on WhatsApp and I will gladly answer your questions so you can take the first step with clarity.</p>`,
  },
  {
    ...
    seoDescriptionEn: 'Titanium is the gold standard with decades of evidence. Zirconia is metal-free and highly aesthetic for thin gums. Which one fits your case, and why.',
...
<p>If you want us to review together which one truly suits you (titanium or zirconia) based on your bone, your gum and the area to rehabilitate, book an evaluation by messaging me directly on WhatsApp. I will gladly answer your questions and tell you, with real data from your mouth, which is the right path for you.</p>`,
  },
  {
    ...
    seoDescriptionEn: 'Told you have no bone for implants? Often that is not true. Zygomatic implants anchor into the cheekbone, avoid grafts and rebuild an atrophic upper jaw.',
...
<p>Book an evaluation to assess your case with a 3D scan and understand, with real data, which solution is right for you. <a href="/en/servicios/implantes-cigomaticos">Learn more about my zygomatic implants service here</a> or message me directly on WhatsApp with your questions.</p>`,
  },
  {
    ...
    seoDescriptionEn: 'Fixed teeth the same day is a real technique: immediate loading. Who qualifies for teeth in a day in Medellín and, with the same honesty, who does not.',
...
<p>If you have been postponing a solution because the idea of being left without teeth terrifies you, this is exactly what is worth evaluating. With 17 years of experience and more than 3,500 patients, my commitment is to tell you the truth about your case and, if you qualify, to give you back your smile in the safest way possible.</p>`,
  },
  {
    ...
    seoDescriptionEn: 'The three seals that make an implant brand trustworthy: scientific backing, regulatory clearance and track record. Which ones I use in Medellín, and why.',
...
<p>In the last decade, Colombia and Medellín in particular have emerged as one of the most important destinations worldwide for dental tourism. Patients from the United States, Canada, Spain, Chile, Venezuela and around the world travel specifically to Medellín for complex dental treatments.</p>`,
  },
  {
    ...
    seoDescriptionEn: 'Zirconia crown or metal-ceramic: esthetics, the gray line at the gum, strength and durability. How to choose the right material for your case in Medellín.',
...
<p>When you receive an implant quote, make sure it includes: the diagnostic consultation and CBCT scan where applicable, the implant and all its components (abutment, screw), the surgery and anesthesia, the immediate post-operative reviews, and the definitive crown or prosthesis. A quote that only covers the "implant" without the crown can be misleading.</p>`,
  },
  {
    ...
    seoDescriptionEn: 'Whitening does not fix an uneven smile. Advanced dental aesthetics redesigns shape, proportion, color and gum line, with digital design you see first.',
