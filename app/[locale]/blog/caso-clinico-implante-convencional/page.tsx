          ...
          <AnimatedSection>
            <div className="relative aspect-[16/7] rounded-xl overflow-hidden border border-dashed flex items-center justify-center" style={{ borderColor: '#C9A461', background: 'rgba(201,164,97,0.04)' }}>
              <div className="text-center p-8">
                ...
                <p className="text-xs mt-1" style={{ color: '#77726A' }}>Envía las fotos del caso clínico para completar esta sección</p>
              </div>
            </div>
          </AnimatedSection>
        </div>
            ...
            <div className="rounded-xl border border-[#C9A461]/30 overflow-hidden" style={{ background: 'rgba(201,164,97,0.04)' }}>
              <div className="aspect-video flex flex-col items-center justify-center gap-4 p-8">
                ...
                <div className="text-center">
                  <p className="font-semibold mb-1" style={{ color: '#211E18' }}>Video de la cirugía, próximamente</p>
                  <p className="text-sm" style={{ color: '#77726A' }}>Desde la planificación digital hasta el resultado final con corona de zirconio.</p>
                </div>
                <WhatsAppLink
          ...
          {[
            ...
            <div key={i}>
              <p className="text-2xl md:text-3xl font-bold" style={{ color: '#C9A461', fontFamily: 'var(--font-playfair-display, serif)' }}>
                {stat.value}<span className="text-sm font-normal ml-1" style={{ color: '#77726A' }}>{stat.unit}</span>
              </p>
