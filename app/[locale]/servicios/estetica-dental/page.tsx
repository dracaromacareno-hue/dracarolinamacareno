...
export async function generateMetadata({
  ...
  return {
    title: isEs
      ? 'Estética Dental Avanzada en Medellín | Dra. Carolina'
      : 'Advanced Dental Aesthetics in Medellín | Dr. Carolina',
    description: isEs
...
export default async function EsteticaDentalPage({
  ...
  const waMessage = 'Hola, me interesa información sobre Estética Dental';

  const breadcrumbs = [
    { name: isEs ? 'Inicio' : 'Home', url: isEs ? BASE : `${BASE}/en` },
    { name: isEs ? 'Servicios' : 'Services', url: isEs ? `${BASE}/servicios` : `${BASE}/en/servicios` },
    { name: isEs ? 'Estética Dental' : 'Aesthetic Dentistry', url: isEs ? `${BASE}/servicios/estetica-dental` : `${BASE}/en/servicios/estetica-dental` },
  ];
      ...
      <section className="pt-32 pb-16 px-4" style={{ backgroundColor: '#070B14' }}>
        <div className="max-w-4xl mx-auto">
          ...
          <AnimatedSection delay={0.1}>
            ...
            >
              Estética Dental Avanzada en Medellín
            </h1>
