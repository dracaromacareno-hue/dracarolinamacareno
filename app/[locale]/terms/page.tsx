    ...
    <>
      ...
      <article className="bg-[#FCFBF9] text-[#211E18] min-h-screen pt-32 pb-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 text-[#5A5449] text-base leading-relaxed">
            {isEs ? (
              <>
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>1. Quién presta el servicio</h2>
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>2. Información del sitio web</h2>
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>3. Rangos de precios y presupuestos</h2>
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>4. Resultados clínicos</h2>
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>6. Propiedad intelectual</h2>
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>7. Jurisdicción</h2>
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>8. Cambios</h2>
              ...
              <>
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>1. Who provides the service</h2>
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>2. Website information</h2>
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>3. Price ranges and quotes</h2>
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>4. Clinical outcomes</h2>
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>6. Intellectual property</h2>
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>7. Jurisdiction</h2>
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>8. Changes</h2>
