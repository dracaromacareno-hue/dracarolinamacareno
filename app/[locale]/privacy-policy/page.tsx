    ...
    <>
      ...
      <article className="bg-[#FCFBF9] text-[#211E18] min-h-screen pt-32 pb-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-[#77726A] text-sm mb-12">
            {isEs ? 'Última actualización' : 'Last updated'}: {LAST_UPDATED}
          </p>

          <div className="prose prose-invert max-w-none space-y-8 text-[#5A5449] text-base leading-relaxed">
            {isEs ? (
              <>
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>1. Quién soy</h2>
                  <p>
                    Esta web pertenece a la <strong>Dra. Carolina Macareno</strong>, odontóloga especialista en Rehabilitación Oral, con consultorio en Cra. 25 #1A Sur-155, Cons. 1353, Edificio Platinum Superior, El Poblado, Medellín, Colombia. Para asuntos de privacidad puedes escribirme a <a href="mailto:dracarolinamacarenob@gmail.com" className="text-[#8A6B2E] underline">dracarolinamacarenob@gmail.com</a> o por WhatsApp al <a href="https://wa.me/573163975232" className="text-[#8A6B2E] underline">+57 316 397 5232</a>.
                  </p>
                </section>

                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>2. Qué información recolecto</h2>
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>3. Para qué uso esta información</h2>
                  <ul className="list-disc pl-6 space-y-2">
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>4. Con quién comparto datos (proveedores)</h2>
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>5. Tus derechos</h2>
                  ...
                  <p className="mt-3">Para ejercer cualquiera de estos derechos, escríbeme a <a href="mailto:dracarolinamacarenob@gmail.com" className="text-[#8A6B2E] underline">dracarolinamacarenob@gmail.com</a>. Respondo en menos de 30 días.</p>
                </section>

                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>6. Pacientes en Europa (GDPR)</h2>
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>7. Pacientes en California (CCPA / CPRA)</h2>
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>8. Pacientes en Colombia (Ley 1581 de 2012, Habeas Data)</h2>
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>9. Información médica</h2>
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>10. Menores</h2>
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>11. Cambios a esta política</h2>
              ...
              <>
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>1. Who I am</h2>
                  <p>
                    This website belongs to <strong>Dr. Carolina Macareno</strong>, oral rehabilitation specialist, with practice at Cra. 25 #1A Sur-155, Cons. 1353, Edificio Platinum Superior, El Poblado, Medellín, Colombia. For privacy matters write to <a href="mailto:dracarolinamacarenob@gmail.com" className="text-[#8A6B2E] underline">dracarolinamacarenob@gmail.com</a> or via WhatsApp at <a href="https://wa.me/573163975232" className="text-[#8A6B2E] underline">+57 316 397 5232</a>.
                  </p>
                </section>

                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>2. What information I collect</h2>
                  <ul className="list-disc pl-6 space-y-2">
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>3. Why I use this information</h2>
                  <ul className="list-disc pl-6 space-y-2">
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>4. Who I share data with (providers)</h2>
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>5. Your rights</h2>
                  ...
                  <p className="mt-3">To exercise any of these rights, email me at <a href="mailto:dracarolinamacarenob@gmail.com" className="text-[#8A6B2E] underline">dracarolinamacarenob@gmail.com</a>. I respond within 30 days.</p>
                </section>

                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>6. EU / UK patients (GDPR)</h2>
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>7. California patients (CCPA / CPRA)</h2>
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>8. Colombian patients (Law 1581 of 2012, Habeas Data)</h2>
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>9. Medical information</h2>
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>10. Minors</h2>
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#8A6B2E] mb-3" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>11. Changes to this policy</h2>
