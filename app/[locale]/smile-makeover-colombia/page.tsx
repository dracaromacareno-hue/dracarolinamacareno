      ...
      <section className="py-20 px-4" style={{ background: 'linear-gradient(135deg, #FFFFFF 0%, #FCFBF9 55%, #F6F1E8 100%)' }}>
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="mb-8" style={{ color: '#5A5449' }}>
            {isEs
              ? 'Sin compromiso. Respuesta en menos de 24 horas. Envíanos fotos de tu sonrisa y te decimos qué es posible.'
              : 'No commitment. Response in less than 24 hours. Send us photos of your smile and we\'ll tell you what\'s possible.'}
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
