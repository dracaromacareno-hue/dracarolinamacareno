...
export async function generateMetadata({
  ...
  return {
    ...
    description: isEs
      ? 'Cirugía maxilofacial en El Poblado, Medellín: terceros molares, cirugía ortognática y procedimientos orales complejos. Especialista integrado en el equipo.'
...
export default async function CirugiaMaxilofacialPage({
  ...
  const waMessage = 'Hola, me interesa información sobre Cirugía Maxilofacial';
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <AnimatedSection delay={0.1}>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight" style={{ color: '#211E18', fontFamily: 'var(--font-playfair-display, serif)' }}>
              {isEs ? 'Cirugía Maxilofacial en Medellín' : 'Maxillofacial Surgery in Medellín'}
            </h1>
        ...
        <div className="max-w-2xl mx-auto text-center">
          <AnimatedSection>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <WhatsAppLink message={waMessage} locale={locale as 'es' | 'en'} trackingLabel="cirugia_maxilofacial_cta" className="inline-flex items-center justify-center gap-3 px-8 py-4 rounded-xl font-semibold text-base transition-all hover:scale-105 bg-[#C9A461] text-[#070B14]">
