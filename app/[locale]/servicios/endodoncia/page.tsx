...
export default async function EndodonciaPage({
  ...
  const waMessage = 'Hola, me interesa información sobre Endodoncia';
        ...
        <div className="max-w-2xl mx-auto text-center">
          <AnimatedSection>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <WhatsAppLink message={waMessage} locale={locale as 'es' | 'en'} trackingLabel="endodoncia_cta" className="inline-flex items-center justify-center gap-3 px-8 py-4 rounded-xl font-semibold text-base transition-all hover:scale-105 bg-[#C9A461] text-[#070B14]">
