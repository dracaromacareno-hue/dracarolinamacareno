  ...
  return (
    <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: bg }}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          {cases.map((caso, i) => (
            <motion.article
              ...
              className="rounded-2xl overflow-hidden border border-[#1F2937] bg-[#0D1321]"
            >
              {/* Par de fotos */}
              <div className="relative grid grid-cols-2">
                ...
                <div className="relative aspect-[4/3] bg-[#111827]">
                  ...
                  />
                  <span className="absolute top-2.5 left-2.5 text-[10px] sm:text-xs font-bold px-2 py-1 rounded tracking-widest uppercase bg-[#070B14]/80 text-[#9CA3AF] backdrop-blur-sm">
                    {t.antes}
                  </span>
                </div>
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-9 h-9 rounded-full bg-[#070B14] border-2 border-[#C9A461] flex items-center justify-center shadow-lg pointer-events-none">
                  <svg className="w-4 h-4 text-[#C9A461]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
              ...
              <div className="p-5 sm:p-6">
                ...
                <p className="text-sm sm:text-base leading-relaxed mt-2" style={{ color: '#D1D5DB' }}>
        ...
        {/* Disclaimer honesto */}
        {showDisclaimer && (
          <p className="text-xs text-center mt-8 sm:mt-10 max-w-3xl mx-auto leading-relaxed" style={{ color: '#6B7280' }}>
            {t.disclaimer}
          </p>
        )}
      </div>
