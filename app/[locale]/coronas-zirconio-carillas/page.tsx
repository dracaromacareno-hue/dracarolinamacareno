...
const WA_EN = "Hi, I'm interested in zirconia crowns or ceramic veneers in Medellín";
...
export async function generateMetadata({
  ...
  return {
    title: isEs
      ? 'Coronas de Zirconio y Carillas en Medellín'
      : 'Zirconia Crowns & Veneers in Medellín',
    description: isEs
      ? 'Coronas de zirconio y carillas cerámicas premium en Medellín. Desde $550 USD por pieza (vs $1.500-2.500 USA). Laboratorio premium, resultados naturales.'
    ...
    <div style={{ backgroundColor: '#FCFBF9', minHeight: '100vh', fontFamily: 'system-ui, sans-serif' }}>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4"
        ...
        <div className="flex items-center gap-3">
          ...
          <WhatsAppLink message={WA} locale={locale as 'es' | 'en'} trackingLabel="coronas_nav_consulta"
      ...
      <section className="relative pt-28 pb-20 px-4 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <WhatsAppLink message={WA} locale={locale as 'es' | 'en'} trackingLabel="coronas_hero"
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-8 p-6 rounded-2xl border max-w-3xl mx-auto text-center" style={{ backgroundColor: 'rgba(201,164,97,0.05)', borderColor: 'rgba(201,164,97,0.2)' }}>
            <p className="text-sm" style={{ color: '#5A5449' }}>
              {isEs
                ? '¿No sabes cuál necesitas? Envíanos fotos de tus dientes y te decimos exactamente qué corresponde en tu caso, sin compromiso.'
                : 'Not sure which you need? Send us photos of your teeth and we\'ll tell you exactly what applies in your case, no commitment.'}
            </p>
            <div className="flex justify-center mt-4">
              <WhatsAppLink message={WA} locale={locale as 'es' | 'en'} trackingLabel="coronas_guia_consulta"
          ...
          <div className="p-8 md:p-12 rounded-2xl border" style={{ backgroundColor: 'rgba(201,164,97,0.04)', borderColor: 'rgba(201,164,97,0.2)' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                ...
                <WhatsAppLink message={WA} locale={locale as 'es' | 'en'} trackingLabel="coronas_especialista_directo"
      ...
      <section className="py-20 px-4" style={{ background: 'linear-gradient(135deg, #FFFFFF 0%, #FCFBF9 55%, #F6F1E8 100%)' }}>
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="mb-8" style={{ color: '#5A5449' }}>
            {isEs
              ? 'Sin compromiso. Respuesta en menos de 24 horas. Envíanos fotos de los dientes que quieres restaurar y te decimos exactamente qué necesitas.'
              : 'No commitment. Response in less than 24 hours. Send us photos of the teeth you want to restore and we\'ll tell you exactly what you need.'}
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <WhatsAppLink message={WA} locale={locale as 'es' | 'en'} trackingLabel="coronas_cta_whatsapp"
