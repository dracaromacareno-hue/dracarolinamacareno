...
export async function generateMetadata({
  ...
  return {
    ...
    description: isEs
      ...
      : 'Books by Dr. Carolina Macareno, oral rehabilitation specialist in Medellín. The Power of Your Smile: how your teeth shape your confidence and image.',
    alternates: {
    ...
    <>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="bg-white border border-[#E8E3DA] rounded-lg overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-0">
              {/* Book visual */}
              <div className="flex items-center justify-center p-10 bg-[#FCFBF9] border-b md:border-b-0 md:border-r border-[#E8E3DA]">
              ...
              <div className="md:col-span-2 p-8">
                <AnimatedSection>
                  <span className="inline-flex items-center gap-2 bg-[#C9A461]/10 border border-[#C9A461]/30 text-[#8A6B2E] text-xs px-3 py-1 rounded mb-4">
                  ...
                  <p className="text-[#8A6B2E] text-sm mb-1 italic" style={{ fontFamily: 'var(--font-playfair-display, serif)' }}>
                    {isEs
                  ...
                  <p className="text-[#5A5449] leading-relaxed mb-6 text-sm">
                    {isEs
