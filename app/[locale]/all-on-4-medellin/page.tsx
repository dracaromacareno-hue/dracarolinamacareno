      ...
      <section className="py-16 px-4" style={{ backgroundColor: '#FCFBF9' }}>
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-xs text-center mt-4" style={{ color: '#77726A' }}>
            {isEs
              ? '* Desde $10.000 con prótesis definitiva híbrida en acrílico, y desde $13.000 en zirconio, que tiene varias opciones. El valor incluye los 4 implantes, la cirugía, la regeneración ósea o la elevación de seno maxilar cuando el caso lo necesita, la prótesis temporal fija que usas durante la cicatrización, la prótesis definitiva y el seguimiento. Todo el proceso se planifica de forma digital, con implantes del Grupo Straumann, la compañía suiza líder mundial en implantología, y lo ejecutan especialistas con años de experiencia clínica. Al comparar con otra cotización, verifica si incluye injerto y elevación de seno: muchas no los incluyen.'
              : '* From $10,000 with a definitive hybrid acrylic prosthesis, and from $13,000 in zirconia, which comes in several options. The price includes the 4 implants, surgery, bone grafting or a sinus lift when the case needs it, the fixed temporary prosthesis you wear during healing, the definitive prosthesis and follow-up. The entire process is planned digitally, with implants from the Straumann Group, the Swiss company that leads implantology worldwide, and it is carried out by specialists with years of clinical experience. When comparing another quote, check whether it includes grafting and a sinus lift: many do not.'}
          </p>
        </div>
      </section>
